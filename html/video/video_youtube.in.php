<div class="tabs">
    <input type="radio" name="ctrl" class="ctrlparts" id="ctrlYoutube" checked='true' />
    <input type="radio" name="ctrl" class="ctrlparts" id="ctrlView" />


    <label class="ctrlparts-lab" id="ctrlYoutube-lab" for="ctrlYoutube">
        Video
    </label>
    ...
    <div class="tab" id="youtube">
        ...
        <br />
        <label for="autoplay"><input type="checkbox" name="VALUE[2]" value="1" id="autoplay" <?=('REX_VALUE[2]' == 1 ? 'checked' : null);?> /> Autoplay</label><br />
